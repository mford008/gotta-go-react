...
<html>
	...
	<body>
		<div id="testResults">
			...
			<p><strong>Test 5</strong>: Save and load Redux state tree containing an <u>Immutable.js</u> data structure: <span id="test5"></span></p>
			<p><strong>Test 6</strong>: Save and load Redux state tree containing both <u>regular JavaScript objects</u> and <u>Immutable.js</u> data structures: <span id="test6"></span></p>
